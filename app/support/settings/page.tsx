...
import { User as UserIcon, Mail, Phone, MapPin, Lock, Eye, EyeOff, Headphones } from "lucide-react"
        ...
        <Card className="border-cyan-500/30 bg-cyan-500/5">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-foreground">Cuenta de Soporte</p>
                <p className="text-sm text-muted-foreground">
                  Acceso a gestion de ventas y soporte al cliente
                </p>
              </div>
            </div>
          </CardContent>
