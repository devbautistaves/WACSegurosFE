...
export default function NewSalePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const [plansRes, supervisorsRes] = await Promise.all([
          plansAPI.getAll(token),
          usersAPI.getSupervisors(token),
        ])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const saleData = {
      ...
      ...(selectedSupervisor && { supervisorId: selectedSupervisor._id }),
      customerInfo: {
...
// Subir archivos adjuntos si existen
      ...
      // Notificar a admins y soportes de la nueva venta
