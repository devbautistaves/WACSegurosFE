...
import { Plus, Search, Eye, Send, ArrowRight, Globe, Clock, CheckCircle, Pause, Trash2 } from "lucide-react"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function SellerDemosPage() {
  ...
  const loadDemos = async () => {
    try {
      ...
      const response = await tpyDemosAPI.getMyDemos(token, filters)
      if (response.success) {
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    Se eliminara la demo de {demo.webName}. Esta accion no se puede deshacer.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                  ...
                                  >
                                    {deletingId === demo._id ? "Eliminando..." : "Eliminar"}
                                  </AlertDialogAction>
                                </AlertDialogFooter>
                              </AlertDialogContent>
                            </AlertDialog>
